...
import {Operators, Title, Wrapper, Img, AmountContainer, Amount, Description} from "./WishProduct.style";
import {openMoreInfoModal} from "../../../redux/modalReducer";

const WishProduct = ({product, deleteFromCart, increment, decrement, moreInfo}) => {
